...
#endif
            VL_FATAL_MT("tb.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb___024root___ctor_var_reset(Vtb___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->tb__DOT__vector_a[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->tb__DOT__vector_b[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->tb__DOT__vector_out = VL_RAND_RESET_I(19);
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->tb__DOT__dut__DOT__temp[__Vi0] = VL_RAND_RESET_I(16);
    }
    vlSelf->tb__DOT__dut__DOT__sum = VL_RAND_RESET_I(19);
